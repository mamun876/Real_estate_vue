<template>
    ...
    <section
      ...
      style="background-image: url(frontend/assets/images/banner/banner-1.jpg)"
    >
                ...
                <div class="tab active-tab" id="tab-1">
                  <div class="inner-box">
                          ...
                          <div class="col-lg-4 col-md-6 col-sm-12 column">
                            <div class="form-group">
                              ...
                              <div class="select-box">
                                ...
                                <select class="wide">
                                  <option data-display="Input location">
                                    Input location
                                  </option>
                    ...
                    <div class="switch_btn_one">
                      <button
                        class="nav-btn nav-toggler navSidebar-button clearfix search__toggler"
                      >
                        ...
                        <div class="row clearfix">
                          ...
                          <div class="col-lg-4 col-md-6 col-sm-12 column">
                            <div class="form-group">
                              ...
                              <div class="select-box">
                                <select class="wide">
                                  <option data-display="Any Agency">
                                    Any Agency
                                  </option>
