              ...
              <div class="place-block-one">
                <div class="inner-box">
                  <figure class="image-box">
                    <img
                      src="frontend/assets/images/resource/place-1.jpg"
                      alt=""
                    />
                  </figure>
                  <div class="text">
            ...
            >
              <div class="place-block-one">
                <div class="inner-box">
                  <figure class="image-box">
                    <img
                      src="frontend/assets/images/resource/place-2.jpg"
                      alt=""
                    />
                  </figure>
                  <div class="text">
            ...
            >
              <div class="place-block-one">
                <div class="inner-box">
                  <figure class="image-box">
                    <img
                      src="frontend/assets/images/resource/place-3.jpg"
                      alt=""
                    />
                  </figure>
                  <div class="text">
            ...
            >
              <div class="place-block-one">
                <div class="inner-box">
                  <figure class="image-box">
                    <img
                      src="frontend/assets/images/resource/place-4.jpg"
                      alt=""
                    />
                  </figure>
                  <div class="text">
